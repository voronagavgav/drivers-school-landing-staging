...
import { createCategory, updateCategory, type FormState } from "@/app/admin/actions";
...
export function CategoryForm({ mode, data }: { mode: "create" | "edit"; data?: CategoryFormData }) {
